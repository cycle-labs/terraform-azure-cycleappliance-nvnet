...
output "connect_now" {
  value = "ssh -i keys/your_private_key ${azurerm_linux_virtual_machine.cycleappliancevm.admin_username}@${azurerm_network_interface.cycleappliancenic.private_ip_address}"
}
